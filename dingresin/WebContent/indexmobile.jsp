...
function openApp(){
	...
	dd.device.launcher.launchApp({
	    app: 'weixin', //iOS:应用scheme;Android:应用包名
...
<body >
	...
	&nbsp;成为盘古的一份子，您当前在钉钉的<code>userId</code>为：
	<div id="userId" style="display:inline-block;font-weight:bold"></div> ,
	&nbsp;设备ID：<div id="userunitId" style="display:inline-block;font-weight:bold"></div> ,
	&nbsp;热点ID：<div id="userwifiId" style="display:inline-block;font-weight:bold"></div> 。</div>
	<br>
 <ul>
<li>
...
<li>
  ...
  <div class="text">定位当前位置</div>
</li>

<li>
  <div class="icon">12&nbsp;&nbsp;</div>
  <div class="text">扫描内容</div>
</li>
</ul>
 <script type="text/javascript">
